...
export default function App() {
  ...
  return (
    <div className="min-h-screen text-gray-800 bg-gradient-to-b from-white via-rose-50 to-white">
      ...
      <main className="max-w-5xl mx-auto px-4 md:px-6">
        ...
        <section id="gallery" className="py-16">
          <h2 className="text-3xl md:text-4xl font-semibold text-center mb-10">相册</h2>
          <Gallery />
        </section>
